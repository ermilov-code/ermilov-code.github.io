...
const sliderGallery = document.querySelector('.swiper-gallery-container');
...
const sliderLicenses = document.querySelector('.swiper-licenses-container');

let myImageSliderLicenses = new Swiper(sliderLicenses, {
    // Стрелки
    navigation: {
        nextEl: '.swiper-licenses-navigation__button-next',
        prevEl: '.swiper-licenses-navigation__button-prev'
    },
    // Навигация 
    // Буллеты, текущее положение, прогрессбар
    pagination: {
        el: '.swiper-licenses-pagination',
